...
numIters = 30
matName = 'absolute_accelerometer_automatic_' + sys.argv[1] + '_' + sys.argv[2] + '.mat'
                ...
                for g in range(numGestures):
                    for t in range(numTrials):
                        if t == trainTrials[g]:
                            ...
                            ng = file[experimentData['emgHV64'][t,apTrain,g]][expLabel>0,:]
            ...
            for g in range(numGestures):
                for t in range(numTrials):
                    if t != trainTrials[g]:
                        ...
                        ng = file[experimentData['emgHV64'][t,apTest,g]][expLabel>0,:]
