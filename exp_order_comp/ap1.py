...
if clusterType == 'auto':
    matName = imType + '_' + emgHVType + '_' + contextType + '_' + clusterType + '_' + str(autoThreshold) + '_' + str(numTrainPositions) + '_' + str(numIters) + '.mat'
else:
    matName = imType + '_' + emgHVType + '_' + contextType + '_' + clusterType + '_' + str(numTrainPositions) + '_' + str(numIters) + '.mat'
